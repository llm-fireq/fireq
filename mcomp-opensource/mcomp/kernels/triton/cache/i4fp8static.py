...
@triton.jit
def i4fp8_quantize_pack_save_kernel(
    ...
    for g in range(0, BLOCK_SIZE, group_size):
        ...
        tl.store(scale_ptr + scale_offset + group_id, scale.to(tl.float8e4nv))
...
def triton_i4fp8_quantize_pack_save(
    ...
    i4fp8_quantize_pack_save_kernel[grid](
        input_tensor,
        output_tensor,
        scale_tensor,
        start_pos,
